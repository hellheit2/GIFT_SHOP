...
public interface GoodsService {
    ...
    public Page<GoodsWrapDTO> getAllGoodsList(GoodsSearchDTO goodsSearchDTO, Pageable pageable); //상품 전체 목록
    public Page<GoodsWrapDTO> getMainGoodsPage(GoodsSearchDTO goodsSearchDTO, Pageable pageable); //메인페이지 상품 리스트
}
